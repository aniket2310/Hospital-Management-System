...
public class Patient {
    ...
    public  void addPatient(){
        ...
        try {
            ...
            preparedStatement.setString(1, name);       //setting the place holder value(?,?,?);
            preparedStatement.setInt(2, age);            //setting the place holder value(?,?,?);
            preparedStatement.setString(3, gender);      //setting the place holder value(?,?,?);
